...
with col1:
    st.image("data/movie_poster/family.jpeg", width=225, use_column_width=False)
with col2:
    st.markdown("""
    <style>
    .info-table {
    ...
    <div class="info-table">
        <p><strong>개봉</strong> 2023.09.21.</p>
        <p><strong>등급</strong> 15세 이상 관람가</p>
        <p><strong>장르</strong> 코미디</p>
        <p><strong>국가</strong> 대한민국</p>
        <p><strong>러닝타임</strong> 99분</p>
        <p><strong>배급</strong> (주)NEW</p>
    </div>

    <div class="rating-section">
        <p><strong>실관람객 평점</strong>  3.57/10</p>
    </div>
    """, unsafe_allow_html=True)
...
df_reviews = get_sum_reviews_tables(movie_id=2)
